...
def _preprocess_formd_funds(dataFrame):
    ...
    dataFrame.form_d_funds = dataFrame.form_d_funds.str.replace('(', '')
    dataFrame.form_d_funds = dataFrame.form_d_funds.str.replace(')', '')
    dataFrame.form_d_funds = dataFrame.form_d_funds.str.replace(',', '')
    dataFrame.form_d_funds = dataFrame.form_d_funds.str.replace('.', '')
    dataFrame.form_d_funds = dataFrame.form_d_funds.str.replace('@', '')
...
def _preprocess_formadv_firms(dataFrame):
    def _transform_formadv_firms(value):
        value = value.upper()
        remove_terms = {
            'LLC', 'LP', 'LTD', 'INC', 'CO', 'CORP'
        }
    ...
    dataFrame.form_adv_firms = dataFrame.form_adv_firms.str.replace('(', '')
    dataFrame.form_adv_firms = dataFrame.form_adv_firms.str.replace(')', '')
    dataFrame.form_adv_firms = dataFrame.form_adv_firms.str.replace(',', '')
    dataFrame.form_adv_firms = dataFrame.form_adv_firms.str.replace('.', '')
    dataFrame.form_adv_firms = dataFrame.form_adv_firms.str.replace('@', '')
    ...
    dataFrame.form_adv_firms = dataFrame.form_adv_firms.str.replace('-', ' ')
    dataFrame.form_adv_firms = dataFrame.form_adv_firms.str.replace('&', ' ')
    dataFrame.form_adv_firms = dataFrame.form_adv_firms.apply(_transform_formadv_firms)
    dataFrame.form_adv_firms = dataFrame.form_adv_firms.str.title()
...
def _preprocess_formadv_funds(dataFrame):
    ...
    dataFrame.form_adv_funds = dataFrame.form_adv_funds.str.replace('(', '')
    dataFrame.form_adv_funds = dataFrame.form_adv_funds.str.replace(')', '')
    dataFrame.form_adv_funds = dataFrame.form_adv_funds.str.replace(',', '')
    dataFrame.form_adv_funds = dataFrame.form_adv_funds.str.replace('.', '')
    dataFrame.form_adv_funds = dataFrame.form_adv_funds.str.replace('@', '')
...
def preprocess(dataframe: pd.DataFrame, **parm):
    ...
    if parm.get('formadv_firms'):
        return _preprocess_formadv_firms(dataframe)
