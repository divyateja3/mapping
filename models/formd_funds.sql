SELECT firms_regulatoryfirm.firm_id, formd_firmformdvalue.entity_name AS "fund_d_name", firms_regulatoryfirm.cik_no AS "cik_no_fund" FROM formd_firmformdvalue
LEFT JOIN (
